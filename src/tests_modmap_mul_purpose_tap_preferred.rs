...
#[test]
fn test_tap_preferred_is_not_emitted_on_press_cur() {
    assert_actions(
        indoc! {"
        modmap:
            - remap:
...
#[test]
fn test_tap_preferred_released_before_timeout_cur() {
    assert_actions(
        indoc! {"
        modmap:
            - remap:
...
#[test]
fn test_tap_preferred_interrupted_before_timeout_cur() {
    assert_actions(
        indoc! {"
        modmap:
            - remap:
...
#[test]
fn test_tap_preferred_interrupted_before_timeout_and_repeated_cur() {
    // Repeat is ignored.
    assert_actions(
        indoc! {"
        modmap:
...
#[test]
fn test_tap_preferred_repeated_before_timeout_cur() {
    assert_actions(
        indoc! {"
        modmap:
            - remap:
...
#[test]
fn test_tap_preferred_released_in_hold_preferred_state_cur() {
...
#[test]
fn test_tap_preferred_interrupted_in_hold_preferred_state_cur() {
    let mut handler = EventHandlerForTest::new(indoc! {"
        modmap:
            - remap:
                CAPSLOCK:
